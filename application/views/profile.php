                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-user"></i> User Profile <span class="fa fa-chevron-right"></span></a>
                            ...
                            <div class="x_content">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                   ...
                                   echo "<ul class='list-unstyled user_data'' >";
                                      ...
                                      echo  "<li >";
                                        echo    "<i class='fa fa-briefcase user-profile-icon '>".$detail->category."</i >";
                                      echo  "</li >";

                                      echo  "<li class='m-top-xs' >";
                                       echo     "<i class='fa fa-external-link user-profile-icon'>";
                                        echo "</i >";
                                       echo     "<a href = .$detail->email.>";
                                        echo"</a >";
                                      echo  "</li >";
                                  echo  "</ul >";
                                    }
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            ...
                                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">All Submisions</a>
                                            </li>
                                            <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Profile Details</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <ul class="messages">
                                                   ...
                                                   <li>
                                                        ...
                                                        <img src="<?php echo base_url('assets/images1/img.jpg')?>" class='avatar' alt='Avatar'>
                                                    <?php
