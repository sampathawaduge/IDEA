                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> User Profile <span class="fa fa-chevron-right"></span></a>

                            </li>
                            <li><a><i class="fa fa-desktop"></i> FAQ<span class="fa fa-chevron-right"></span></a>

                            </li>
                            <li><a><i class="fa fa-table"></i> About Us <span class="fa fa-chevron-right"></span></a>
